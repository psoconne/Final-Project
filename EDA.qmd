...
> Below we find that there are no missing values.
...
>   -  Below are summary statistics, such as count, mean, sd, etc., for the three numerical variables in the data set.
